              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {individualCategories.map((cat) => (
                  <div key={cat.id} className="bg-zinc-50 dark:bg-zinc-900/50 p-3 rounded-xl border border-zinc-100 dark:border-zinc-850">
                    <label htmlFor={`modal-member-${cat.id}`} className="block text-xs font-bold text-zinc-600 dark:text-zinc-400 uppercase mb-1.5 flex items-center justify-between gap-1">
